...
class UnexpectedExpressMocker {
  constructor(options) {
    ...
    this.expectedErrorPassedToNext = options.expectedErrorPassedToNext;
  }
    ...
    return makePromise((resolve, reject) => {
      ...
      .then(() => {
        ...
        if (errorPassedToNext) {
          ...
          if (typeof this.expectedErrorPassedToNext !== 'undefined') {
            if (this.expectedErrorPassedToNext === true) {
              context.metadata.errorPassedToNext = true;
            } else if (typeof this.expectedErrorPassedToNext === 'string') {
