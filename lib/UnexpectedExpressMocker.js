...
class UnexpectedExpressMocker {
  constructor(options, expect) {
    // TODO: pull Unexpected out of the mocker
    this.expect = expect;
    ...
    const {
      ...
      expectedMetadata
    } = resolveExpectedResponseProperties(options);

    this.requestProperties = requestProperties;
    this.expectedResponseProperties = expectedResponseProperties;
    this.expectedMetadata = expectedMetadata;
  }

  mock(subject) {
    const { requestProperties, expectedMetadata } = this;
    ...
    return this.expect
      ...
      .then(() => {
        if (res.connection._writableState.corked > 0) {
          ...
          return this.expect.promise((resolve, reject) => {
