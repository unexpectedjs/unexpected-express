...
module.exports = function (expect) {
    ...
    expect.addAssertion('function', 'to yield exchange', function (expect, subject, value, _done) {
            ...
            try {
                if (errorPassedToNext) {
                    ...
                    if (typeof expectedMetadata.errorPassedToNext !== 'undefined') {
                        ...
                        res.statusCode = errorPassedToNext.statusCode;
                        res._header = 'HTTP/1.1 ' + res.statusCode + ' ' + http.STATUS_CODES[res.statusCode] + '\r\nContent-Type: text/plain\r\n';
                ...
                // Avoid: "// should be 200 Bad Request" when no expected status message is provided
                if (res._header && typeof expectedResponseProperties.statusCode === 'number' && typeof expectedResponseProperties.statusMessage === 'undefined' && expectedResponseProperties.statusCode in http.STATUS_CODES) {
                    expectedResponseProperties.statusMessage = http.STATUS_CODES[expectedResponseProperties.statusCode];
                }
                ...
                try {
                    ...
                    if (expectedResponseProperties.headers) {
                    ...
                    expect.fail(function (output) {
                        ...
                        return output
                            .append(expect.inspect(httpRequest)).nl(2)
                            .append(expect.diff(httpResponse, expectedHttpResponse).diff);
                   });
                }
