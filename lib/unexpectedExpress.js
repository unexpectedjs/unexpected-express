...
module.exports = function (expect) {
    ...
    expect.addAssertion('function', 'to be middleware that processes', function (expect, subject, value, _done) {
        ...
        if (typeof expectedResponseProperties.statusCode === 'number' && typeof expectedResponseProperties.statusMessage === 'undefined' && expectedResponseProperties.statusCode in http.STATUS_CODES) {
