...
function applyRequestBodyToToReq(
  req,
  requestBodyState,
  requestBody,
  updateHttpRequestBody
) {
  if (requestBodyState) {
    const { hasFormData, hasStream } = requestBodyState;
...
function classifyRequestBodyAndUpdateHttpRequest(requestBody, httpRequest) {
...
function resolveRequestBody(requestProperties, httpRequest) {
  ...
  installInto(expect) {
    ...
    expect.exportAssertion(
      ...
      (expect, subject, value) => {
        ...
        applyRequestBodyToToReq(
          req,
          requestBodyState,
          requestBodyState && !requestBodyState.hasStream
            ? httpRequest.unchunkedBody
            : requestBody,
          updateHttpRequestBody
        );
