        ...
        function doTheAssertions(errorPassedToNext) {
            ...
            try {
                ...
                if (responseBodyChunks.length > 0) {
                    ...
                    if ((typeof expectedResponseProperties.body === 'string' || (typeof expectedResponseProperties.body === 'object' && !Buffer.isBuffer(expectedResponseProperties.body))) || (typeof expectedResponseProperties.body === 'undefined' && isTextualContentType(res._headers['content-type']))) {
                        try {
