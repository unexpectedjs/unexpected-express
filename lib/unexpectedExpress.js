            ...
            try {
                ...
                try {
                    ...
                    expect.fail(function (output) {
                        ...
                        output.append(expect.inspect(httpRequest)).nl(2);
                        var statusLineSatisfied = false;
                        try {
                            expect(httpResponse.statusLine, 'to satisfy', expectedHttpResponse.statusLine);
                            statusLineSatisfied = true;
                        } catch (e) {}
                        if (statusLineSatisfied) {
                        ...
                        var bodySatisfied = true;
                        if ('body' in expectedHttpResponse) {
                            try {
                                expect(httpResponse, 'to satisfy', {body: expectedHttpResponse.body});
                            } catch (e) {
                                bodySatisfied = false;
                            }
                        }
